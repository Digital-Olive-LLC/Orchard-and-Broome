      ...
      register('announcement-bar', {
        ...
        onLoad() {
          ...
          if (announcements.length > 1) {
            module.import('./index-df6c75ea.nomodule.js').then(function (n) { return n.i; }).then(({
              default: Flickity
            }) => {
    ...
    `);
      ...
      register('header', {
        onLoad() {
          ...
          const quickCart = QuickCart(n$2('[data-quick-cart]', this.container));// These all return a function for cleanup
      ...
      register('slideshow', {
        ...
        onLoad() {
          ...
          if (parallax == 'true') {
            module.import('./simpleParallax.min-b0a73b25.nomodule.js').then(function (n) { return n.s; }).then(({
      ...
      register('video', {
        onLoad() {
          ...
          const firstPlayClick = () => {
            module.import('./fluorescent-video.es-476616ad.nomodule.js').then(({
              default: Video
            }) => {
      ...
      const filterHandler = ({
        ...
        let filters = null;
        let delegate = null;
        module.import('./filtering-ef724993.nomodule.js').then(({
          default: filtering
        }) => {
...
//# sourceMappingURL=theme-5852ef97.nomodule.js.map

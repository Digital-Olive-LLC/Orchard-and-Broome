...
register('announcement-bar', {
  ...
  onLoad() {
    ...
    if (announcements.length > 1) {
      import('./index-ba2f80d6.js').then(function (n) { return n.i; }).then(({
        default: Flickity
      }) => {
...
register('slideshow', {
  ...
  onLoad() {
    ...
    if (parallax == 'true') {
      import('./simpleParallax.min-cd6261d9.js').then(function (n) { return n.s; }).then(({
...
register('video', {
  onLoad() {
    ...
    const firstPlayClick = () => {
      import('./fluorescent-video.es-649649b1.js').then(({
        default: Video
      }) => {
...
const filterHandler = ({
  ...
  let filters = null;
  let delegate = null;
  import('./filtering-ff0b9a23.js').then(({
    default: filtering
  }) => {
...
//# sourceMappingURL=theme-be00ac56.js.map
